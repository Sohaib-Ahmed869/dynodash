...
import rentalitem3 from "../Assets/rentalitem3.png";
          ...
          <div className="w-2/3 text-left p-10 flex flex-col">
            <div className="flex flex-col">
              ...
              <p className="text-lg text-gray-500 mt-5">
                ...
                accusantium dolore mque laud antium, totam rem aperiam, eaque
              ...
              <p className="text-lg text-gray-500 mt-5">
                ...
                es qui dolorem ipsum quia dolor sit amet consectetur, adipisci
                velit sed quia non numquam eius modiy.
              </p>
